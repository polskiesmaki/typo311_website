<?php
class Standard_action_module_7365b23d8e71c7476e0c408680f1896d5b5c0cf1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '" class="form-control input-login t3js-clearable t3js-login-username-field" autofocus="autofocus" autocomplete="username" required="required" spellcheck="false" />
...
$output0 .= '" width="14" height="14" alt="" title="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$arguments7 = [
'key' => 'login.error.capslockStatus',
'id' => NULL,
'default' => NULL,
'arguments' => NULL,
'extensionName' => NULL,
...
$output0 .= '" class="form-control input-login t3js-clearable t3js-login-password-field" autocomplete="current-password" required="required" spellcheck="false" />
                <div role="status" class="form-notice-capslock hidden t3js-login-alert-capslock">
                    <img aria-hidden="true" src="';
...
$output17 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('forgetPasswordUrl')]);

<?php
class partial_legend_9b394f9f32949cebd6d74436b3e2212f4ae9d56c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<ul class="workspace-legend">
    <li><span class="workspace-state-unchanged">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$output0 .= '</span></li>
    <li><span class="workspace-state-modified">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$output0 .= '</span></li>
    <li><span class="workspace-state-moved">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$output0 .= '</span></li>
    <li><span class="workspace-state-new">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$output0 .= '</span></li>
    <li><span  class="workspace-state-hidden">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$output0 .= '</span></li>
    <li><span class="workspace-state-deleted">';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
